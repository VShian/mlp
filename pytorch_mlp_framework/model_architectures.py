...
class ConvolutionalBatchNormResidualConnectionProcessingBlock(nn.Module):
    def __init__(self, input_shape, num_filters, kernel_size, padding, bias, dilation):
        super(ConvolutionalBatchNormResidualConnectionProcessingBlock, self).__init__()
...
class ConvolutionalBatchNormResidualConnectionDimensionalityReductionBlock(nn.Module):
    def __init__(self, input_shape, num_filters, kernel_size, padding, bias, dilation, reduction_factor):
        super(ConvolutionalBatchNormResidualConnectionDimensionalityReductionBlock, self).__init__()
